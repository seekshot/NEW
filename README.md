...
This demo uses **only mock/sample data**. No real bank connections. The code is structured so Plaid/Flinks/Notion + MCP can be wired later, but everything shown here is offline/local and safe for portfolio screenshots.
